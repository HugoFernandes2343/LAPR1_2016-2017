...
public class MetodoAHP {
    ...
    public static void main(String[] args/*,double limiar,String Input,String Output*/) throws FileNotFoundException {
        ...
        do {
            op = menu();
                    ...
                    N_CRITERIOS=verificacaoLimiar(limiar,matrizCriterios,m_cabecalhos,matrizTotalCriterios);
            ...
            switch (op) {
                case 1:
                    ...
                    selecaoOutput(Output, op, RCValues,matrizCriterios,m_cabecalhos,matrizTotalCriterios,matrizSomatorios,matrizCriteriosNormalizada,matrizTotalNormalizacao,mPrioridadeRelativa);
                    break;
                case 2:
                    RCValues = verificarConsistencia(op, RCValues, mPrioridadeRelativa, matrizCriterios, matrizTotalCriterios);
                    selecaoOutput(Output, op, RCValues,matrizCriterios,m_cabecalhos,matrizTotalCriterios,matrizSomatorios,matrizCriteriosNormalizada,matrizTotalNormalizacao,mPrioridadeRelativa);
    ...
    public static double[][] atualizarMatrizesLimiar(int posicao,double[][] matrizCriterios,String[][] m_cabecalhos,double[][] matrizTotalCriterios){
        double[][] matrizDadosIrrelevantesPesos=new double[N_CRITERIOS][N_CRITERIOS];
        String[] matrizDadosIrrelevantesCabecalhoPesos=new String[N_CRITERIOS];
        double[][] matrizDadosIrrelevantesCriterios=new double[matrizTotalCriterios.length][matrizTotalCriterios[0].length];
        ...
        /*Ja coloca os pesos mas falta a matriz que agora é inutil e ainda colocar tudo numa matriz maior no método anterior e no main
        assim ja se pode mandar para o output
        */
        return matrizCriterios;
    }
    ...
    public static void selecaoOutput(String Output,int op,double[][] RCValues,double[][] matrizCriterios,String[][] m_cabecalhos,double[][] matrizTotalCriterios,double[][] matrizSomatorios,double[][] matrizCriteriosNormalizada,double[][] matrizTotalNormalizacao,double[][] mPrioridadeRelativa) throws FileNotFoundException{
        double escolhas[][];String[][] matrizTotal=new String[100][100];int nLinhasOutput=0;
